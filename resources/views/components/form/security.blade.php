...
<form method="post" action="{{ route('user.update_security', $user) }}">
    ...
    <div class="form-label-group">
        <input type="password" name="new_password_confirmation" id="inputNewPasswordConfirmation" placeholder="Confirm New Password" class="form-control @error('new_password') is-invalid @enderror" required>
